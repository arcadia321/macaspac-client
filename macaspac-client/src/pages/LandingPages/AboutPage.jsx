...
import toteImage from '../../assets/img/Tote.png';
import notesImage from '../../assets/img/notepack.png';
          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                <img src={toteImage} alt="Campus Tote" className="h-full w-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                <img src={notesImage} alt="Daily Notes Pack" className="h-full w-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                <img src={tumblerImage} alt="Stainless Tumbler" className="h-full w-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                <img src={lampImage} alt="Wireless Study Lamp" className="h-full w-full object-cover" />
              </div>
            </div>
