                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                            <img src={toteImage} alt="Daily Essentials" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                            <img src={notesImage} alt="Study Supplies" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="overflow-hidden rounded-[1.25rem] bg-zinc-200">
                            <img src={hoodieImage} alt="Campus Apparel" className="h-full w-full object-cover" />
                        </div>
